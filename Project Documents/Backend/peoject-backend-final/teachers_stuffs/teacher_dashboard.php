...
<main>
    <?php if (isset($profile)): ?>
        <input type="hidden" name="reg_id" value="<?php echo $profile['reg_id']; ?>">
    ...
    <div id='course_list_div' style="display: none;">
        ...
        <table>
            ...
            <?php foreach ($teacher_profile as $tprofile) : ?>
                <tr>
    ...
    <div id='profile_div' style="display: none;">
        ...
        <form action="." method="post" id="aligned">
            ...
            <input type="hidden" name="reg_id" value="<?php echo htmlspecialchars($tprofile['reg_id']); ?>"<br>
            <label>Full Name:</label>
            <input type="text" name="fullname" value="<?php echo htmlspecialchars($tprofile['name']); ?>"><br>

            <label>Gender:</label>
            <?php if ($tprofile['gender'] == 'male'): ?>
                <input type="radio" name="gender" value="Male" checked> Male<br>
            <?php elseif (($tprofile['gender'] == 'female')): ?>
            ...
            <label>DOB:</label>
            <input type="text" name="dob" value="<?php echo htmlspecialchars($tprofile['dob']); ?>"><br>

            <label>Email:</label>
            <input type="text" name="email" value="<?php echo htmlspecialchars($tprofile['email']); ?>"><br>
